...
```SQL
create table T_GEEK (	FAV_PROG_LANG varchar(255), 
...
```SQL
create table T_PERSON (id bigint generated by default as identity, 
...
from T_PERSON person0_ left outer join T_GEEK person0_1_ on person0_.id=person0_1_.id
```
